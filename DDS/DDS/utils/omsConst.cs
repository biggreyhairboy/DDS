...
namespace DDS.lib
{
    public static class omsConst
    {
            ...
            public const int OMS_EXCH_SELECT          = 80   ;          //koo: user selected exchange destination  
            ...
            public const int OMS_BOND_YTM             = 119  ;      // Yield to maturity
            ...
            public const int OMS_SERIESID             = 141  ; // Special broker routing for Global Future
            public const int OMS_ORIGINALPROD         = 142  ;
            ...
            public const int OMS_FQuotaLimit          = 164  ; // Store the Remain Future Quota
            public const int OMS_SQuotaLimit          = 165  ; // Store the Remain Stock Quota
            public const int OMS_OPTION_STYLE         = 170  ;
            public const int OMS_IMPLIED_VOL          = 171  ;
            public const int OMS_CALL_PRICE           = 172  ; // For callable securities such as cbbc
            public const int OMS_BID_IMPLIED_VOL      = 173  ;
            public const int OMS_ASK_IMPLIED_VOL      = 174  ;
            ...
            public const int OMS_SECID                = 425  ;    // add for amsTrade.secID
           
            public const int OMS_DAILY_TLIMIT         = 431  ;     // koo: kingsway: DTL
            public const int OMS_BOD_DAILY_TLIMIT     = 432  ;     // koo: kingsway: DTL initial value.
            public const int OMS_ALGO_COMMAND         = 440  ;     // Louis: Algo command used by algo watch
            public const int OMS_DATA_EXTENDED        = 441  ;     // Louis: Extended data to be stored in order
            public const int OMS_STATUS_FLAGS         = 442  ;     // Louis: Order Status indicators other than normal status
            public const int OMS_HOLDFUND_ISMV        = 443  ;
            public const int OMS_HOLDFUND_USMV        = 444  ;
            public const int OMS_CUTLOSS              = 445  ;
            public const int OMS_UnRealPL             = 446  ;
            public const int OMS_HOLD_DATE            = 447  ;     //Justin: HoldFundGateWay Bussiness value
            public const int OMS_CALENDAR_DATE        = 448  ;     //Justin: HoldFundGateWay Calendar Date value
            public const int OMS_MARGINLIMIT          = 449  ;
            
            public const int OMS_TOTAL_APPROVALPENDING= 450  ;     // koo: sinopac: total amount of approval pending
            ...
            public const int OMS_MIN_TICK             = 507  ;  //  Minimum Price Tick (For Global Futures)
            ...
            public const int OMS_OPTION_THETA         = 517  ;
            public const int OMS_OPTION_RHO           = 518  ;
            public const int OMS_MACHINE_ID           = 520  ;    // For ITS
            public const int OMS_GIVE_UP_MEMBER       = 521  ;    // In oapi 17, place order
            public const int OMS_REQ_NO               = 530  ;    // KOO: UW: request reference number
            public const int OMS_OPEN_FOR_APPROVAL    = 531  ;
            public const int OMS_SETTLED_DATE         = 540  ;
            public const int OMS_BOI_STATUS           = 541  ;
            public const int OMS_LEG_COUNT            = 542  ;
            public const int OMS_LEG_RATIO            = 543  ;
            public const int OMS_LEG_SYMBOLS          = 544  ;
            ...
            public const int OMS_WITHDRAWABLECASH_BAL = 700  ;  //the value of withdraw  able Cashbalance
            public const int OMS_TOTALSHORTCOMPS      = 880  ;  // The value of short sell value
            ...
            public const int OMS_TRADED_QTY           = 1210;      // koo: accumulated traded qty for FIX.
            public const int OMS_RECORD_COUNT         = 1211;      // koo: number of records at tag 1212.
            public const int OMS_RECORDS              = 1212;      // koo: multi-leg trade-order(s) information
            ...
            public const int OMS_GTC_INFO             = 1304;   // koo: kingsway: '<order create date>, <original order price>, <total order quantity>'
            ...
            public const int OMS_HKMEX_TRADE_HALT_TYPE = 1404;
            ...
            public const int DCASS_SIMULATE_POSITION   = 3020;     // 0 = Only use trades specified in the query
            ...
            public const int DCASS_SIMULATE_OUTLEVEL   = 3021;     // 1 = Only sum margin requirements
                                           // 2 = Level 1 + margin results per series
                                          // 3 = Level 2 + prices and valuation interval per series
                                           // 4 = Level 3 + volatilities for options
            public const int DCASS_SIMULATE_ITEMTYPE   = 3022;     // 1. Specify market to use. If no item with type 1 is provided, all markets are used. It is possible to use 2 markets, by providing two items with item type = 1
                                          // 2. Bought trade
                                           // 3. Sold trade
                                             // 4. Payment
                                           // 5. Bought Delivery
